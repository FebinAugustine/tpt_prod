  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        >
          <h2 className="text-sm font-bold text-black">Popular Products</h2>
          <p className="text-gray-600 text-xs">Top picks for you</p>
        </motion.div>
        ...
        {products.map((product, index) => (
          <motion.div
            ...
            transition={{ duration: 0.3, delay: index * 0.05 }}
              ...
              >
                ...
                {/* Product Info */}
                 <div className="p-2 md:p-2.5">
                  {/* Product Name */}
              <h3 
                 className="text-gray-900 text-[11px] md:text-[12px] font-semibold mb-0.5 line-clamp-1 cursor-pointer hover:text-red-600 transition-colors"
                 onClick={() => router.push(`/product/${product._id}`)}
               >
                {product.name}
              </h3>
              ...
              {/* Description */}
              {product.description && (
                  <p className="text-gray-500 text-[10px] md:text-[10px] line-clamp-1 mb-1.5">
                  {product.description}
                </p>
              )}
