...
export default function TrendingProductsSection({ isVerified, className = "" }: TrendingProductsSectionProps) {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        // Filter trending and active products
        const trendingProducts = response.data
          .filter((product: Product) => product.isTrending && product.isActive)
